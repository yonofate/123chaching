...
function accountFree() {
    var a = window.location.hostname,
        b = "0"; - 1 != a.search(DomainDemo + "/") ? (b = "1", showWatermark(b)) : $.ajax({
            "async": true,
            "crossDomain": true,
...
$(document).ready(function () {
    ...
    b.init(), showPopupLoadPage(), $(".pn-close-fb-mes").unbind("click").click(function (a) {
        var b = $(this).parent();
    ...
    }), stickyRun(), carouselRun(), animatedtext(), fixCss() 
});
