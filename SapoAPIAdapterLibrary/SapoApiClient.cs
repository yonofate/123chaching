...
{
    /// <summary>
    /// This class is used to make Sapo API calls 
    /// </summary>
    /// <remarks>
    /// You will first need to use the SapoAPIAuthorizer to obtain the required authorization.
    /// </remarks>
    /// <seealso cref="http://api.sapo.com/"/>
    public class SapoAPIClient
    {
        ...
        /// <summary>
        /// Make an HTTP Request to the Sapo API
        /// </summary>
        ...
        {
            string url = String.Format("https://{0}.mysapo.net{1}", State.ShopName, path);
        ...
        public object Call(Method method, string path, object callParams)
        {
            ...
            request.AddHeader("host", $"{this.State.ShopName}.mysapo.net");
            request.AddHeader("X-Bizweb-Access-Token", this.State.AccessToken);
        ...
        /// <summary>
        /// Make a Get method HTTP request to the Sapo API
        /// </summary>
        ...
        /// <summary>
        /// Make a Post method HTTP request to the Sapo API
        /// </summary>
        /// <param name="path">the path where the API call will be made.</param>
        ...
        /// <summary>
        /// Make a Put method HTTP request to the Sapo API
        /// </summary>
        /// <param name="path">the path where the API call will be made.</param>
        /// <param name="data">the data that this path will be expecting</param>
        /// <seealso cref="http://api.sapo.com/"/>
        ...
        /// <summary>
        /// Make a Delete method HTTP request to the Sapo API
        /// </summary>
        /// <param name="path">the path where the API call will be made.</param>
        /// <seealso cref="http://api.sapo.com/"/>
        /// <returns>the server response</returns>
        ...
        /// <summary>
        /// The default content type used on the HTTP Requests to the Sapo API
        /// </summary>
        ...
        /// </summary>
        protected SapoAuthorizationState State { get; set; }

        /// <summary>
        /// Used to translate the data sent and recieved by the Sapo API
        /// </summary>
        /// <example>
