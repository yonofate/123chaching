...
namespace HaravanAPIAdapterLibrary
{
    ...
    {
        /// <summary>
        /// Given a C# object, return a JSON string that can be used by the Haravan API
        /// </summary>
        ...
        /// </summary>
        /// <param name="encodedData">JSON string return from the Haravan API</param>
        /// <returns>c# object corresponding to the JSON data return from the Haravan API</returns>
