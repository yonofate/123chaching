...
namespace SapoAPIAdapterLibrary
{
    ...
    {
        /// <summary>
        /// Given a C# object, return a JSON string that can be used by the Sapo API
        /// </summary>
        ...
        /// </summary>
        /// <param name="encodedData">JSON string return from the Sapo API</param>
        /// <returns>c# object corresponding to the JSON data return from the Sapo API</returns>
