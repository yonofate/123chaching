...
(function () {
    ...
    AbstractChosen = (function () {
        ...
        AbstractChosen.prototype.container_width = function () {
            ...
            if (this.options.width != null) {
                ...
                return "" + $(this.form_field).css("width");
            }
        };
    ...
    Chosen = (function (_super) {
        ...
        Chosen.prototype.set_up_html = function () {
            ...
            /* gtm */
            var gtmData = '';
            if (this.form_field.getAttribute("data-gtm-event")) {
                gtmData = 'data-gtm-event="' + this.form_field.getAttribute("data-gtm-event") + '"';
            }
            if (this.form_field.getAttribute("data-gtm-category")) {
                gtmData += ' data-gtm-category="' + this.form_field.getAttribute("data-gtm-category") + '"';
            }
            if (this.form_field.getAttribute("data-gtm-action")) {
                gtmData += ' data-gtm-action="' + this.form_field.getAttribute("data-gtm-action") + '"';
            }

            if (this.is_multiple) {
                this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div>');
            } else {
                this.container.html('<a ' + gtmData + ' class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" /></div><ul class="chosen-results"></ul></div>');
            }
        ...
        Chosen.prototype.single_set_selected_text = function (text) {
            ...
            //return this.selected_item.find("span").append(text);
